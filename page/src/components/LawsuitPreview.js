...
const LawsuitPreview = props => {
  ...
  if (props.lawsuit.sigilo === true) {
    return <LawsuitSecret lawsuit={props.lawsuit} />
  } else {
    return (
      <div
        onClick={() => navigate('/exibir/' + props.lawsuit.numero)}
        className="container-list pt-4"
      >
        ...
        <ul className="row align-items-start mt-3">
          <div className='row'>
            <div className="col-4">
              <div className="preview_titulo">
              {props.lawsuit.info_header.info0.titulo}
              </div>
              <div className="preview_cont">
              {' '}
              {props.lawsuit.info_header.info0.conteudo}
              </div>
            </div>
            <div className="col-4">
              <div className="preview_titulo">
              {props.lawsuit.info_header.info1.titulo}
              </div>
              <div className="preview_cont">
              {' '}
              {props.lawsuit.info_header.info1.conteudo}
              </div>
            </div>
            <div className="col-4">
              <div className="preview_titulo">
              {props.lawsuit.info_header.info4.titulo}
              </div>
              <div className="preview_cont">
              {' '}
              {props.lawsuit.info_header.info4.conteudo}
              </div>
             </div>
          </div>
          <div className='row'>
            ...
            <div className="col-4">
              ...
              <div className="preview_cont">
              {' '}
              {props.lawsuit.ultima_mov.data} -{' '}
              {props.lawsuit.ultima_mov.titulo}
              </div>
            </div>
          </div>
        </ul>
